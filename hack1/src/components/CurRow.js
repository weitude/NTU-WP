...
const CurRow = ({curGuess, rowIdx}) =>
{
    ...
    return (
        ...
        <div className='Row-wrapper current'>
            ...
            <div id={rowIdx + "-1"} key={rowIdx + "-1"}
                 className={"Row-wordbox " + state[len - 1]}>{letters[1]}</div>
            <div id={rowIdx + "-2"} key={rowIdx + "-2"}
                 className={"Row-wordbox " + state[len - 2]}>{letters[2]}</div>
            <div id={rowIdx + "-3"} key={rowIdx + "-3"}
                 className={"Row-wordbox " + state[len - 3]}>{letters[3]}</div>
